...
public class CapSteamFindAllTest {
    ...
    @Test
    void shouldReturnVideogames() throws Exception {
        // GIVEN
        String genre = "ACTION";
        ...
        when(videogameService.findAll(pageable)).thenReturn(pageVg);
    ...
    void shouldReturnEmptyWhenNoVideogamesForGivenYear() throws Exception {
        ...
        when(videogameService.findAll(pageable)).thenReturn(emptyPage);
